...
#define PWMA PORTAbits.RA0 
#define PWMB PORTAbits.RA1

#define AIN2 PORTAbits.RA2
#define AIN1 PORTAbits.RA3 
#define STBY PORTAbits.RA4

#define BIN1 PORTAbits.RA5 
#define BIN2 PORTCbits.RC1
...
int main()
{
    ...
    ADCON1bits.PCFG = 13; //AN0 and AN1 are analog, the rest are digital
